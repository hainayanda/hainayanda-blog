...
import { Skills, Skill } from '../models/skills';
...
const MOCK_ABOUT: MainPage = {
  ...
  paragraph: "Everything started even before I'm going to college. It started in my high school period. Started when I try and learn by myself to exploit some open source bot for online games until I decided to seriously learn about programming. \n\n" +
...
const MOCK_SKILLS: Skills = {
  ...
  otherSkills: ["Spring Framework", "AngularJS", "JQuery", "SQL", "MongoDB", "REST API", ".Net Core", "ASP .NET", "Microcontroller", "Basic Electronics"]
}
